...
def load_data(folder):
    return {
        ...
        "train_labels_real": np.load(os.path.join(folder, 'train_labels_real.npy')),
        "train_labels_gen": np.load(os.path.join(folder, 'train_labels_gen.npy')),
        "test_labels_real": np.load(os.path.join(folder, 'test_labels_real.npy')),
        "test_labels_gen": np.load(os.path.join(folder, 'test_labels_gen.npy')),
